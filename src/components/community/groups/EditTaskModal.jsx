...
import { FiX, FiUser, FiCalendar, FiAlertCircle } from 'react-icons/fi';
...
export default function EditTaskModal({ isOpen, onClose, onSubmit, task, members }) {
  ...
  // Preenche o formulário quando a tarefa é recebida
  useEffect(() => {
    if (task) {
      setFormData({
        title: task.title || '',
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">Edit Task</DialogTitle>
            <DialogDescription>
                Atualize os detalhes da tarefa existente, como título, descrição, prazo, prioridade, status e responsável.
            </DialogDescription>
        </DialogHeader>
