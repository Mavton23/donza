...
export default function LegalPage() {
  ...
  return (
    <Box maxWidth="md" sx={{ py: 4, mx: 'auto', px: 3 }}>
      <Helmet>
        <title>
          {isTerms ? 'Termos de Serviço' : 'Política de Privacidade'} - Donza
        </title>
        <meta
          name="description"
          content={
            isTerms
              ? 'Termos de uso da plataforma educacional Donza'
              : 'Política de privacidade da plataforma educacional Donza'
          }
        />
      </Helmet>
      ...
      {isTerms ? (
        <Box mb={6}>
          ...
          <Typography variant="h4" component="h2" gutterBottom mt={4}>
            6. Moderação e Remoção de Conteúdo
          </Typography>
          <Typography paragraph>
      ...
      <Box mt={4} textAlign="center">
        ...
        <Typography paragraph>
          Para quaisquer dúvidas sobre {isTerms ? 'os Termos' : 'nossa Política de Privacidade'}, entre em contato conosco:
        </Typography>
        <Typography>
