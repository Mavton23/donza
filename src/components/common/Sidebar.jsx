...
export default function Sidebar({ isMobileOpen, setIsMobileOpen }) {
  ...
  const instructorNav = [
    ...
    },
    {
      ...
      icon: UserCog,
      submenu: [
        { name: "Meus Cursos", href: "/instructor/courses", icon: BookOpen },
        { name: "Criar Curso", href: "/instructor/courses/create", icon: FileText },
        { name: "Aulas", href: "/instructor/lessons", icon: Video },
