    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        <div className="bg-yellow-100 dark:bg-yellow-900 p-4 flex items-center">
          <FaExclamationTriangle className="h-8 w-8 text-yellow-600 dark:text-yellow-300 mr-3" />
        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Você não tem permissão para acessar esta página. Por favor, entre em contato com o administrador se acredita que isto é um erro.
            </p>
          </div>
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mt-6 p-3 bg-gray-100 dark:bg-gray-700 rounded-md">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">
                Função atual: {localStorage.getItem('userRole') || 'desconhecida'}
              </p>
            </div>
          )}
        </div>
